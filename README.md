...
在工业应用中，常常遇到需要将直流电转化为交流电的情况，逆变器Inverter便可以实现这样的功能。比如在电动汽车中，动力电池输出的电是直流电，驱动汽车运动的电机所需要的是三相交流电。
...
设计逆变桥的时候，有全桥逆变，单管逆变，和半桥逆变。全桥逆变电路的输出功率更高，开关损耗更小，可接纳的控制方式更多。？？那这里选用的三相桥式逆变电路是全桥还是半桥？？全桥和半桥有什么区别吗？？<br>
**设计全桥电路的三个要点**：<br>
...
设计供电电源电路的时候，需要考虑到隔离。供电电路为控制系统提供+15V，-15V和+5V的直流电压。设计时供电电路采用两个变压器，分别对控制保护部分和功率模块部分提供电源，其中给功率模块供电变压器的直流输出要分别绕线，不能有公共结点。[^7]
