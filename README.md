...
设计IGBT驱动电路的时候，需要考虑到信号发生电路和信号隔离电路的设计。<br>
IGBT一般需要15V的驱动电压，但是控制器能够提供的电压是3.3-5V，所以需要设计信号发生电路使电压满足设计需要。并且信号发生电路要**产生两路带死区互补的方波信号**，否则会造成IGBT的误导通。
